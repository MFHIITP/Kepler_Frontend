  ...
  const steps = [
    {
      ...
      description:
        "Master coding basics and programming fundamentals with hands-on practice",
    ...
    },
    {
      ...
      description:
        "Advanced DSA, system design, and project building with real-world applications",
    ...
    },
    {
      ...
      description:
        "Build portfolio, optimize resume, and create an impressive GitHub profile",
    ...
    },
    {
      ...
      description:
        "Interview preparation, mock interviews, and dedicated job placement support",
              ...
              {stats.map((stat, index) => (
                <div key={index} className="relative group">
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 text-center transform hover:-translate-y-2">
                    ...
                    {/* Subtle glow effect */}
                    <div
                      className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${stat.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                    ></div>
                  </div>
                </div>
              ))}
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Follow our structured path from beginner to industry-ready
                professional
              </p>
              <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-pink-500 mx-auto mt-6 rounded-full"></div>
            </div>
                  ...
                  <div key={idx} className="relative group">
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 text-center transform hover:-translate-y-2">
                      ...
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                        <div
                          className={`w-8 h-8 rounded-full bg-gradient-to-r ${step.color} text-white font-bold text-sm flex items-center justify-center shadow-lg`}
                        >
                          {idx + 1}
                        </div>
                      </div>
                      ...
                      {/* Icon */}
                      <div
                        className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${step.color} text-white mb-6 group-hover:scale-110 transition-transform duration-300 mt-4`}
                      >
                        {step.icon}
                      </div>
                  ...
                  <div className="p-8">
                    ...
                    <div className="text-center mb-8">
                      ...
                      <div className="text-center mb-4">
                        {plan.oldPrice && (
                          <div className="text-gray-500 line-through text-2xl font-semibold">
                            {plan.oldPrice}{" "}
                    ...
                    <div className="space-y-4 mb-8">
                      {plan.features.map((feature, idx) => (
                        <div key={idx} className="flex items-start space-x-3">
                          <div
                            className={`flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r ${plan.color} flex items-center justify-center mt-0.5`}
                          >
