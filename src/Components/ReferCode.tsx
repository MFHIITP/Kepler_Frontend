...
function referCode(props) {
  ...
  const handleReferralManagement = async () => {
    localStorage.setItem("profileOption", "Referral Management");
    navigate("/profiles");
  };
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between p-8 lg:p-12">
          ...
          <div className="flex-1 lg:mr-12 mb-8 lg:mb-0">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-2xl leading-relaxed">
              For every successful referral you can win exciting cashbacks and
              help your friends discover amazing learning opportunities.
            </p>
            ...
            <button
              ...
              className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm text-orange-700 bg-white border border-orange-200 shadow-sm hover:bg-orange-50 hover:border-orange-400 hover:shadow-md transition-all duration-200 group"
            >
