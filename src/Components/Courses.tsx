...
function ProfessionalEducationPage() {
  ...
  const features = [
    {
      ...
      description:
        "Interactive live sessions with expert educators and real-time doubt resolution",
    ...
    },
    {
      ...
      description:
        "Comprehensive curriculum designed by education experts for optimal learning outcomes",
    ...
    },
    {
      ...
      description:
        "Collaborative learning environment with peer-to-peer support and group discussions",
    ...
    },
    {
      ...
      description:
        "Learn from industry veterans and top educators with proven track records",
    ...
    },
    {
      ...
      description:
        "AI-powered adaptive practice system that personalizes your learning journey",
    ...
    },
    {
      ...
      description:
        "Instant doubt clearing with detailed explanations and step-by-step solutions",
      ...
      content: [
        {
          ...
          answer:
            "Our live classes feature real-time interaction, instant doubt resolution, and engagement tools that make learning interactive and effective.",
        },
        {
          question: "Can I access recorded sessions?",
          answer:
            "Yes, all live classes are automatically recorded and available for review within 24 hours, with lifetime access included.",
        },
        {
          question: "What technology do you use?",
          answer:
            "We use cutting-edge streaming technology ensuring crystal-clear video quality, minimal latency, and seamless user experience across all devices.",
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="max-w-2xl px-8 lg:px-12 text-white">
                  ...
                  <p className="text-lg lg:text-xl mb-6 text-blue-100">
                    Transform your academic journey with India's most trusted
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Specialized programs designed to help you excel in your target
            examination
          </p>
        </div>
      ...
      >
        <div
          className={`bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transition-all duration-300 ${
          ...
          <div className="sticky top-0 bg-white/95 backdrop-blur-sm border-b border-slate-200 px-8 py-6 rounded-t-3xl flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-slate-800">
                {modalContent[selectedFeature]?.title || selectedFeature}
              </h2>
              <p className="text-slate-600 mt-1">
                {modalContent[selectedFeature]?.subtitle}
              </p>
            </div>
            <button
              onClick={closeModal}
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl p-8 border border-blue-200">
                  ...
                  <p className="text-xl text-slate-700">
                    Experience interactive learning with our expert educators
                    through live and recorded classes designed for comprehensive
                    exam preparation.
                  </p>
                </div>
